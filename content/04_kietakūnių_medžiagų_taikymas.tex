...
\begin{description}
  \item[$W [\frac{A \cdot h}{kg}]$] – savitoji energetinė talpa;
...
išauga plotas. Paprastai, jei turime cilindrą ar 1 ant 1 cm, tai
dėl rėželių mes S išdidiname S iki $5m^{2}$. 1Å \equiv 10^{-10} m
Dabar galime apskaičiuoti talpą:
\begin{equation*}
