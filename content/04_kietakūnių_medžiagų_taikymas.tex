...
padėtimis stimuliuoja šiluminė energija \TODO{formulės},
bei \TODO{neišgirdau}.
...
\TODO{Ko?}. Gibso energija yra išreiškiama:
\begin{align*}
...
\begin{description}
  ...
  \item[$T$] – temperatūra;
  \item[$S_{F}$] – entropijos \FIXME{?} Frenkelio defektą.
\end{description}
...
išstumiamos ir lokalizuojasi \FIXME{Kur?}. Jeigu išeities lentelėse(?)
...
\begin{remember}
  \item Gaminant medžiagas ar tai keramikas, ar tai storuosius,
    plonuosius sluoksnius yra svarbu turėti \FIXME{Kokias?} medžiagas,
  ...
  \item Koks parametras nusako grūdėtumą, kokiais vienetais grūdėtumas
    ...
    formavimui \FIXME{Hipotezė: Kuo didesnis grūdėtumas, tuo tankesnė
    keramika. (Palyginti: \slide{91} a nuotrauką su b)} ir kokia yra
    keramikų nano ar tai mikro sintezė. Tai yra tarp \FIXME{Kokios?}
...
laidumu $\sigma$:
\begin{equation*}
  \sigma = \varepsilon' \varepsilon_{0} \omega \tg \delta.
\end{equation*}
Dabar $\tg \delta$ gali išreikštas, kaip dielektrinių skvarbų santykis:
realios ir menamos. Tokiu atveju, jei vietoj $\tg \delta$ įstatysime
